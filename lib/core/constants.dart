...
class AssetsPath {
  ...
  static const String FONTS_PATH = "assets/fonts";
  ...
  static const String NAV_CHARTS_SVG = "$SVG_PATH/nav_charts.svg";
  static const String NAV_WATCHLIST_SVG = "$SVG_PATH/nav_watchlist.svg";
  static const String WATCHLIST_ADD_LOGO_SVG =
      "$SVG_PATH/watchlist_add_logo.svg";
  static const String WATCHLIST_ARROW_BACK_SVG =
      "$SVG_PATH/watchlist_arrow_back.svg";
  static const String WATCHLIST_ADD_FUND_SVG =
      "$SVG_PATH/watchlist_add_fund.svg";
  static const String WATCHLIST_BOOKMARK_SVG =
      "$SVG_PATH/watchlist_bookmark.svg";
